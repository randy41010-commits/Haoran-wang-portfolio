...
const content = {
  de: ["Ich bin Haoran Wang, Musikproduzent und Künstler an der Schnittstelle von Klang, Musik und künstlerischer Forschung.", "Ich habe Musik und Medien am Shanghai Conservatory of Music studiert und studiere derzeit Klang und Realität an der Robert Schumann Hochschule Düsseldorf.", "Ich arbeite in Komposition, Musikproduktion und Sounddesign. Meine Praxis beginnt oft mit einer präzisen traditionellen Kompositionstechnik und erweitert sich zugleich in experimentelles Theater. Wie Martin Supper, mein Professor an der Universität der Künste Berlin, sagt: „ROOM AS AN INSTRUMENT.“ Jeder Raum ist ein einzigartiges, offenes Feld mit einer eigenen Fähigkeit zu singen."],
  en: ["I am Haoran Wang, a music producer and creator working across sound, music and artistic research.", "I graduated from the Shanghai Conservatory of Music, where I studied Music and Media. I am currently studying Sound and Reality at the Robert Schumann Hochschule Düsseldorf.", "I work across composition, music production and sound design. My practice often begins with rigorous traditional compositional techniques, while also extending into experimental theatre-making. As Martin Supper, my professor at the Berlin University of the Arts, puts it: “ROOM AS AN INSTRUMENT.” Every space is a singular, open field with its own capacity to sing."],
  zh: ["我是 Haoran Wang，一名音乐制作人和创作者，致力于声音、音乐与艺术研究的交叉实践。", "我毕业于上海音乐学院音乐与媒体专业，目前就读于罗伯特·舒曼杜塞尔多夫音乐学院“声音与现实”专业。", "我从事作曲、音乐制作与声音设计。我的创作往往从严谨的传统作曲技法出发，同时延展至实验性剧场实践。正如我在柏林艺术大学的教授 Martin Supper 所说：“ROOM AS AN INSTRUMENT。”每个空间都是独特而开放的场域，拥有自身的歌唱能力。"]
} as const;
